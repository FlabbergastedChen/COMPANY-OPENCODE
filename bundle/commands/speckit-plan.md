...
3. 若 Skill 工具调用失败，回退读取本地文件：`$OPENCODE_CONFIG_DIR/skills/speckit-technical-planning/SKILL.md`，必要时再读 `~/.config/opencode/skills/speckit-technical-planning/SKILL.md`。
